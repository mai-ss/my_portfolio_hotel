...
<body>
    <header class="header">
        <div class="header__menu-food">
            <span></span>
            <span></span>
            <span></span>
        </div>
        <div class="header__link-food" id="__background-check">
            <h1>
        ...
        <div class="header__mainvisual--img-food">
            <img src="img/food_01.jpg" alt="food" data-id="food_01">
            <img src="img/food_02.jpg" alt="food" data-id="food_02" style="display: none;">
        </div>
        <div class="header__mainvisual--img-select">
            <img src="img/food_01.jpg" alt="food" data-img="food_01">
            <img src="img/food_02.jpg" alt="food" data-img="food_02">
        </div>
    ...
    <main class="food-main">
        <section class="food-main__concept">
            <h2 class="food-main__concept--title">お料理</h2>
            <p class="food-main__concept--text">信州の豊かな自然が育んだ新鮮な地元食材をふんだんに使用し、四季を感じる繊細な和会席をご提供いたします。地元の農家から直送される旬の野菜、信州産の川魚、この地ならではの食材を活かしたお料理の数々をご堪能ください。
                料理人のこだわりが光る一皿一皿が、目でも舌でも楽しめる贅沢なひとときをお届けします。
                食事は、お部屋食でごゆっくりとお楽しみいただけます。</p>
        </section>
    </main>
